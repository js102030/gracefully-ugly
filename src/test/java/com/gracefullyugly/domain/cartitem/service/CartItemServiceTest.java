...
public class CartItemServiceTest {
    ...
    void deleteCartItemTest() {
        ...
        Long testCartItemId = cartService.getCartList(testUserId).get(0).getCartItemId();

        // WHEN
        CartItemResponse result = cartItemService.deleteCartItem(testUserId, testCartItemId);
